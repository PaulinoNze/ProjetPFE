...
<li><a href="toutLesEtudiant.php"><span>Etudiant</span></a></li>
<li><a href="ajouterDesFormation.php"><span>Ajouter des Formations</span></a></li>
<li><a href="modifierDesFormation.php"><span>Modifier des Formations</span></a></li>
</ul>
</li>
<li class="submenu">
...
if (mysqli_num_rows($result) > 0) {
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        <tr>
            ...
            <td class="text-right">
            <a href="modifierEdutiant.php?id=<?php echo $row['etudId']; ?>" class="btn btn-primary btn-sm mb-1">
