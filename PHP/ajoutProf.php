<?php
    ...
    $adresse = validate(mysqli_real_escape_string($conn, $_POST['adresse']));
        if(isset($_FILES['image']) && $_FILES['image']['error'] === UPLOAD_ERR_OK){
            ...
            $sql = "INSERT INTO professeur(nom, prenom, email, password, telephone, gender, date_naissance, adresse, image, statut) VALUES ('$nom', '$prenom', '$email', '$password', '$telephone', '$gender', '$dateNaissance', '$adresse', '$imgData', '$statut')";
        } else {
            // Update query without image data
            $sql = "INSERT INTO professeur(nom, prenom, email, password, telephone, gender, date_naissance, adresse, statut) VALUES ('$nom', '$prenom', '$email', '$password', '$telephone', '$gender', '$dateNaissance', '$adresse', '$statut')";
        }
