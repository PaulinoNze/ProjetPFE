...
<a class="dropdown-item" href="modifierprofesseur.php">Modifier le profile</a>
...
<ul class="sidebar-ul">
<li>
<a href="professeurDashboard.php" class="border-top-0"><i class="fas fa-home back-icon"></i> Retour a Accueil</a>
</li>
<li class="menu-title">Parametres</li>
<li>
<a href="professeurSettings.php">Parametres de l'ecole</a>
</li>
<li>
<a href="permissionsprofesseur.php">Permissions</a>
</li>
<li class="active">
...
<li class="breadcrumb-item"><a href="professeurSettings.php">Parametres</a></li>
