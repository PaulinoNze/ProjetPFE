...
<nav class="navbar navbar-expand-lg navbar-light bg-primary">
    <?php
    // Mostrar el nombre y la foto del estudiante si la sesión está configurada correctamente
    if(isset($_SESSION['nom']) && isset($_SESSION['image'])) {
        $nomEstudiant = $_SESSION['nom'];
        $imageEstudiant = $_SESSION['image'];
        echo '<img src="' . $imageEstudiant . '" alt="Foto del Estudiante" class="img-fluid rounded-circle" style="width: 30px; height: 30px; margin-right: 5px;">';
        echo '<a class="navbar-brand" href="#">' . $nomEstudiant . '</a>';
    }
    ?>
...
<nav class="courseware wrapper-course-material" aria-label="Cours">
  <div class="course-material">
    <ol class="course-tabs">
      ...
      <li>
         <a href="#" class="btn btn-primary cargar-pagina" data-url="coursPDF.php">
             PDF du cours
         </a>
      </li>
        ...
        <div id="sidebar-menu" class="sidebar-menu" >
         ...
         <ul class="sidebar-ul"  >
            ...
            <li class="submenu">
                ...
                <li><a href="#" class="btn btn-primary cargar-pagina" data-url="introductio.php"><span>introduction au cours</span></a></li>
                </ul>
            </li>

            <li class="submenu">
                <a href="#"><img src="../../assets/img/sidebar/icon-17.png" alt="icon"> <span> chapitre 1</span> <span class="menu-arrow"></span></a>
                <ul class="list-unstyled"  style="display: none;">
                <li><a href="#" class="btn btn-primary cargar-pagina" data-url="video1.php"><span>contenu du chapitre 1: video</span></a></li>
                <li><a href="#" class="btn btn-primary cargar-pagina" data-url="chuiz1.php"><span>chuiz: contenu du chapitre 1</span></a></li>
                </ul>
            </li>
            <li class="submenu">
                <a href="#"><img src="../../assets/img/sidebar/icon-17.png" alt="icon"> <span> chapitre 2</span> <span class="menu-arrow"></span></a>
                <ul class="list-unstyled" style="display: none;">
                <li><a href="#" class="btn btn-primary cargar-pagina" data-url="video2.php"><span>contenu du chapitre 2: video</span></a></li>
                <li><a href="#" class="btn btn-primary cargar-pagina" data-url="chuiz2.php"><span>chuiz: contenu du chapitre 2</span></a></li>
                </ul>
            </li>
            </li>

            <li class="submenu">
                <a href="#"><img src="../../assets/img/sidebar/icon-17.png" alt="icon"> <span> chapitre 3</span> <span class="menu-arrow"></span></a>
                <ul class="list-unstyled" style="display: none;">
                <li><a href="#"  class="btn btn-primary cargar-pagina" data-url="video3.php"><span>contenu du chapitre 3: video</span></a></li>
                <li><a href="#"  class="btn btn-primary cargar-pagina" data-url="chuiz3.php"><span>chuiz: contenu du chapitre 3</span></a></li>
                </ul>
            </li>
