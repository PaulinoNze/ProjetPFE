                ...
                <div class="sidebar-inner slimscroll">
                    <div id="sidebar-menu" class="sidebar-menu">
                        <div class="header-left">
                            <a href="../adminDashboard/cours.php" class="logo">
                        ...
                        <ul class="sidebar-ul">
                            <li>
                                <a href="../adminDashboard/cours.php" class="border-top-0"><i class="fas fa-home back-icon"></i> Retour a Accueil</a>
                            </li>
                            <li>
                                <a href="#" class="cargar-pagina" data-url="../formation/cours_contenue1/introductio.php?coursId=<?php echo $_GET['id']; ?>  "><img src="../assets/img/sidebar/icon-17.png" alt="icon"><span>introduction</span></a>
                            </li>
                            <?php
                            include "../database.php";
                            if (isset($_GET['id'])) {
                            ...
                            ?>
                                ...
                                <li class="submenu">
                                    ...
                                    <ul class="list-unstyled" style="display: none;">
                                        <li><a href="#" class="cargar-pagina" data-url="exameFinale.php?coursId=<?php echo $coursId; ?>"><span>question de examen finale</span></a></li>
                                    </ul>
                                </li>
                                <li class="submenu">
