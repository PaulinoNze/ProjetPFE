...
?>
    ...
    <body>
                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown2">
                                ...
                                <a class="dropdown-item" href="chapter.php">Capítulo 1</a>
                                <a class="dropdown-item" href="chapter.php">Capítulo 2</a>
                            </div>
                        </li>
                        <li class="nav-item">
        ...
        if (isset($_GET['coursId'])) {
            ...
            $sql = "SELECT nomCours, description, datePublish, image, video, pdf  FROM cours WHERE coursId = $coursId";
